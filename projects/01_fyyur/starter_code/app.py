...
class Venue(db.Model):
    ...
    shows = db.relationship('Artist', secondary=shows, lazy=True, backref=db.backref('shows', lazy=True))
...
class Artist(db.Model):
    ...
    def __repr__(self):
      return '<Artist {} id:{}, city:{}, state:{}, phone: {}, genres: {}>'.format(self.name, self.id, self.city, self.state, self.phone, self.genres)
...
def edit_artist_submission(artist_id):
  ...
  try:
    ...
    db.session.close()
  if error:
    flash('Artist {} could not be edited'.format(artist.name))
  else:
...
def edit_venue_submission(venue_id):
  ...
  if error:
    flash('Venue {} could not be edited!'.format(venue.name))
